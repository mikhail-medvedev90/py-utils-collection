...
TEST_CASES = [
    ...
    },
    {
        "intervals": {
            "lesson": [1000, 2000],
            "pupil": [800, 1200, 1500, 2500],
            "tutor": [900, 1300, 1800, 2200]
        },
        "answer": 400
    },
    {
...
def test_appearance(test_data):
    result = appearance(test_data["intervals"])
    assert result == test_data["answer"], f"Ошибка для интервалов {test_data['intervals']}: получено {result}, ожидалось {test_data['answer']}"
